    ...
    in
    {
      ...
      packages = forAllSystems (
        ...
        let
          ...
          # nix run .#meshbench -- [host] - per-bearer, per-direction delivery
          ...
          # the logic belongs in this repo: meshbench.sh ships
          # mesh-bench-remote.sh over ssh. Both are real files, so ShellCheck
