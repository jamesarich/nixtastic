...
public sealed interface MeshEvent {
    ...
    /**
     * A peer acknowledged a message we sent. [requestId] is the id of the packet being confirmed.
     *
     * Confirms arrival at the addressed node, not that a human read it - Meshtastic acks are
     * generated by the receiving radio.
     */
    public data class Delivered(val from: Long, val requestId: Long) : MeshEvent
